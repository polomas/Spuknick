...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 id="casa">Compras</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li id="claro" class="breadcrumb-item"><a href="#">Home</a></li>
                        <li id="claro" class="breadcrumb-item active">Compra</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="col-md-12">
                    <div class="card card-success">
                        ...
                        <div class="card-body p-0">
                            <header>
                                <div class="logo_cp">
                                    <img src="../img/avatar2.png" width="100" height="100">
                                </div>
                            ...
                            <button id="actualizar" class="btn btn-success my-1">Actualizar</button>
