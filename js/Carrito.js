$(document).ready(function(){
    ...
    $(document).on('click','.agregar-carrito',(e)=>{
        ...
        const stock = $(elemento).attr('prodStock');
            ...
            <td><button class="borrar-producto btn btn-danger btn-sm"><i class="fas fa-times-circle"></i></button></td>
    ...
    function Registrar_compra(cliente) {
        funcion='resgistrar_compra';
        let total=$('#total').get(0).textContent;
        let productos=RecuperarLS();
        let json = JSON.stringify(productos);
        $.post('../controlador/ComprarController.php',{funcion,total,cliente,json},(response)=>{
